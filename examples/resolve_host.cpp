...
int main () {
  ...
  udp_client_v4_t::log_e log_level4 = udp_client_v4_t::log_e::info;
  udp_client_v6_t::log_e log_level6 = udp_client_v6_t::log_e::info;
  ...
  ip4_t host_ip2 = udp_client_v4_t::resolve (host2, nullptr, log_level4);
  printf ("host: %s, resolved ip: %s\n\n", host2.c_str(), host_ip2.to_str().c_str());

  std::string host3 = "some_unreachable_host";
  bool resolve_result3;
  ip4_t host_ip3 = udp_client_v4_t::resolve (host3, &resolve_result3, log_level4);
  ...
  ip6_t host_ip5 = udp_client_v6_t::resolve (host5, nullptr, log_level6);
  printf ("host: %s, resolved ip: %s\n\n", host5.c_str(), host_ip5.to_str().c_str());

  std::string host6 = "some_unreachable_host";
  bool resolve_result6;
  ip6_t host_ip6 = udp_client_v6_t::resolve (host6, &resolve_result6, log_level6);
